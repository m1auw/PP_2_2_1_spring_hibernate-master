...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        userService.add(new User("User1", "Lastname1", "user1@mail.ru", new Car("Model3", 3)));
        ...
        userService.getUserByCarModelAndSeries("Model3", 3).forEach(user -> System.out.println(user.getFirstName()));
